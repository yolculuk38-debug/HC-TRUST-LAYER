...
GitHub rejects CodeQL SARIF uploads from advanced configurations when CodeQL default setup is enabled. A pull request can therefore look like a workflow or permissions hardening change while actually introducing a conflicting CodeQL configuration.
