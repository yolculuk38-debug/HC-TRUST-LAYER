...
| Governance/project-control documents | governance/report channel | governance/report-only; protected/high-risk | Users should read these as advisory governance evidence, but authority and review-boundary wording is high sensitivity. | Future PRs may route governance boundary changes as ordinary docs-only work and skip trust-kernel or human review. | Require protected-surface and human maintainer review for governance documents that affect authority, review boundaries, release posture, workflow interpretation, or trust-kernel behavior. |
