...
| Next up | A narrow fixture/example improvement for the report generator, or a separately reviewed trust-layer proposal. |
...
## Completed docs-only synchronization after #875

- Mode: docs only.
- Safe output: project-control docs reflect #872/#873/#874/#875 and do-not-repeat boundaries.
- This synchronization is complete in the current PR and must not remain the next active task after merge.
