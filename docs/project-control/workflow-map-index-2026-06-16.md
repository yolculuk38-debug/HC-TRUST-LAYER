...
- Initial low-risk reductions merged for `docs-drift.yml`, `terminology.yml`, `verification-package-schema.yml`, and `archive.yml`; these changes narrowed main-push or branch-push behavior without changing permissions, jobs, or scripts.
