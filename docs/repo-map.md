...
| `council/`, `reviewers/`, `witness/`, `timeline/`, `witness-archive/` | Governance, reviewer, witness, timeline, and legacy/historical evidence surfaces. | audit/provenance record | Maintainers; preserve provenance and historical context. | High: historical evidence surfaces; avoid silent rewrites. |
