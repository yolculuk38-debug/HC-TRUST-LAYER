...
- MVP-1 static verification demo index: [`docs/demo-index.md`](docs/demo-index.md)
- MVP-1 CLI verification package viewer: [`docs/mvp-1-cli-viewer.md`](docs/mvp-1-cli-viewer.md)
